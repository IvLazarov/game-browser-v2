...
const Publishers = ({mode}) => {
    ...
    useEffect(()=>{
        fetch(`https://api.rawg.io/api/publishers?key=4bc0eac8b3e74a84a29fa89b0d4181a8`)
...
<Oval 
              ...
              gamePublishers.map(gamePublisher => {
                    return <Link key={gamePublisher.id} to={gamePublisher.slug} className='card'>
                    <img src={gamePublisher.image_background} alt="publisher-image" loading="lazy" />
